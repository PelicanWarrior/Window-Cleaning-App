// Supabase Edge Function: send_invoice_whatsapp
// Deno runtime
// Requires secrets:
// - WHATSAPP_TOKEN: WhatsApp Cloud API token
// - WHATSAPP_PHONE_NUMBER_ID: Phone number ID for the WhatsApp Business account
// This function accepts JSON body: { phoneE164: string, filename: string, pdfBase64: string, messageText?: string }
// It uploads the PDF to WhatsApp media endpoint, then sends a document message to the phone number.
...
interface RequestBody {
  phoneE164: string;
  filename: string;
  pdfBase64: string; // base64 without data URI prefix
  messageText?: string;
}
