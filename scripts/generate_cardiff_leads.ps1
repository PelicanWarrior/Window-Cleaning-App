...
foreach ($url in $all) {
  ...
  $isTargetArea = [regex]::IsMatch($area, 'south-glamorgan|mid-glamorgan|west-glamorgan|gwent|avon|gloucestershire|herefordshire|dyfed|powys|clwyd|gwynedd')
...
$outFile = Join-Path $outDir 'cardiff_day1_leads_100.csv'
