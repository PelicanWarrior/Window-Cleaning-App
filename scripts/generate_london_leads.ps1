...
foreach ($url in $all) {
  ...
  $isTargetArea = [regex]::IsMatch($area, 'london|middlesex|hertfordshire|essex|surrey|kent|berkshire|buckinghamshire')
...
$outFile = Join-Path $outDir 'london_day1_leads_100.csv'
