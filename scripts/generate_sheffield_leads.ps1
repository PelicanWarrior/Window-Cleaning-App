...
foreach ($url in $all) {
  ...
  $isTargetArea = [regex]::IsMatch($area, 'south-yorkshire|derbyshire|nottinghamshire|lincolnshire')
...
$outFile = Join-Path $outDir 'sheffield_day1_leads_100.csv'
